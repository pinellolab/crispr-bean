...
def plot_count_dist_ranked(count_file_name, reps, conditions, sample = ""):
    ...
    figs, axs = plt.subplots(3,3, figsize=(12, 9))
    ...
    lgnd = axs[1, 2].legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
...
def plot_counts_vs_edit_rate(count_file_name, reps, conditions, title = "Guide counts vs edit rate", outfile = None):
    counts_df = pd.read_csv(count_file_name)
    ...
    lgnd = axs[2].legend(bbox_to_anchor=(1.04,0.45), loc="center left", borderaxespad=0)
